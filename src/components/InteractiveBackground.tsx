    ...
    <>
      <div className="liquid-glass-bg pointer-events-none select-none z-0">
        ...
        <motion.div 
          ...
          className="liquid-blob liquid-blob-cyan left-[4vw] top-[8vh] w-[30vw] h-[30vw] max-w-[320px] max-h-[320px] will-change-transform" 
        />
        <motion.div 
          animate={{ x: bgMouse.x * -0.5, y: bgMouse.y * -0.5 }}
          transition={{ type: "tween", ease: "linear", duration: 0 }}
          className="liquid-blob liquid-blob-purple right-[6vw] top-[6vh] w-[35vw] h-[35vw] max-w-[360px] max-h-[360px] will-change-transform" 
        />
        ...
        {!lowPowerMode && (
          <>
            <motion.div 
              ...
              transition={{ type: "tween", ease: "linear", duration: 0 }}
              className="liquid-blob liquid-blob-pink left-[8vw] bottom-[12vh] w-[32vw] h-[32vw] max-w-[320px] max-h-[320px] will-change-transform" 
            />
            <motion.div 
              animate={{ x: bgMouse.x * -0.4, y: bgMouse.y * 0.4 }}
              transition={{ type: "tween", ease: "linear", duration: 0 }}
              className="liquid-blob liquid-blob-indigo right-[12vw] bottom-[14vh] w-[28vw] h-[28vw] max-w-[280px] max-h-[280px] will-change-transform" 
            />
            ...
            <motion.div 
              ...
              transition={{ type: "tween", ease: "linear", duration: 0 }}
              className="liquid-blob liquid-blob-purple left-[35vw] top-[25vh] w-[15vw] h-[15vw] max-w-[150px] max-h-[150px] opacity-80 will-change-transform" 
              style={{ animationDelay: "-5s", filter: "blur(4px)" }} 
            />
            <motion.div 
              animate={{ x: bgMouse.x * 0.8, y: bgMouse.y * -0.7 }}
              transition={{ type: "tween", ease: "linear", duration: 0 }}
              className="liquid-blob liquid-blob-cyan right-[28vw] top-[50vh] w-[18vw] h-[18vw] max-w-[180px] max-h-[180px] opacity-85 will-change-transform" 
              style={{ animationDelay: "-12s", filter: "blur(3px)" }} 
            />
            <motion.div 
              animate={{ x: bgMouse.x * -0.7, y: bgMouse.y * -0.8 }}
              transition={{ type: "tween", ease: "linear", duration: 0 }}
              className="liquid-blob liquid-blob-pink left-[50vw] bottom-[18vh] w-[16vw] h-[16vw] max-w-[160px] max-h-[160px] opacity-75 will-change-transform" 
              style={{ animationDelay: "-8s", filter: "blur(5px)" }} 
            />
            <motion.div 
              animate={{ x: bgMouse.x * 1.1, y: bgMouse.y * 1.1 }}
              transition={{ type: "tween", ease: "linear", duration: 0 }}
              className="liquid-blob liquid-blob-indigo left-[18vw] top-[65vh] w-[14vw] h-[14vw] max-w-[140px] max-h-[140px] opacity-90 will-change-transform" 
